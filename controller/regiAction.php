...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		{
			$sql = "INSERT INTO dabtab1(firstname, lastname, username, password, gender, email, mobileno, address1, country) VALUES('$firstname', '$lastname', '$username', '$password', '$gender', '$email', '$mobileno', '$address1', '$country')";
